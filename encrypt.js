function encrypt(text, rule) {
    ...
    Because every char has an ASCII value, we can manipulate this value with a 
    ...
    */
    ...
    for (let i = 0; i < text.length; i++) {
        let code = text[i].charCodeAt(0) + rule
        code > 255 ? code %= 256 : null
...
console.log(encrypt("yygryqzobvyufknqcpmrutjg", 372)) // "ííÛæíåîãÖêíéÚßâå×äáæéèÞÛ"