function findMultiples(integer, limit) {
    ...
    be positive integers passed into the function, not consisting of 0. The 
    ...
    */
    return Array.apply(null, Array(limit + 1)).map(function (_, i) {return i * integer;}).slice(1, limit/integer+1);
}
